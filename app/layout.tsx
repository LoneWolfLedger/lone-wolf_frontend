        ...
        <div style={{ display: 'flex', height: '100vh', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ width: '260px', background: 'rgba(15, 23, 42, 0.7)', backdropFilter: 'blur(20px)', borderRight: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', padding: '30px 20px' }}>
            ...
            <nav style={{ display: 'flex', flexDirection: 'column', gap: '15px', flex: 1 }}>
              <Link href="/" style={{ color: '#cbd5e1', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 'bold', padding: '10px', borderRadius: '8px', transition: '0.2s' }} onMouseOver={e => e.currentTarget.style.background = 'rgba(255,255,255,0.05)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'}>
                ⎈ TERMINAL MATRIX
              </Link>
              <Link href="/investors" style={{ color: '#cbd5e1', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 'bold', padding: '10px', borderRadius: '8px', transition: '0.2s' }} onMouseOver={e => e.currentTarget.style.background = 'rgba(255,255,255,0.05)'} onMouseOut={e => e.currentTarget.style.background = 'transparent'}>
